                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return ListTile(
                    ...
                    leading: (c.avatar != null &&
                            (c.avatar ?? new Uint8List(0)).length > 0)
      ...
      body: SafeArea(
        child: ListView(
          children: <Widget>[
            ...
            AddressesTile(_contact.postalAddresses ?? List.empty()),
            ItemsTile("Phones", _contact.phones ?? List.empty()),
            ItemsTile("Emails", _contact.emails ?? List.empty())
          ],
        ),
      ),
    );
